...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div
        className={`p-4 grid ${
          adminPhotos.length > 0
            ? "grid-cols-5 min-h-[100vh] justify-center"
            : "grid-cols-1 min-h-[50vh] justify-start"
        } gap-4 w-full `}
      >
        {adminPhotos.length > 0 ? (
          ...
          // IN CASE THERE ARE NO PHOTOS IN ADMIN AREA
          <div className="m-auto">
            <p className="text-4xl text-gray-400  ">
              Start to load and share your best shoots
            </p>
          </div>
        )}
      </div>
      ...
      <div className="m-auto fixed right-4 bottom-4">
        <button
          onClick={() => {
            setCreateMode(true);
            setNewPhotoData({
